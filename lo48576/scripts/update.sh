...
docker-compose -f docker-compose.yml -f docker-compose.override.10-network.yml -f docker-compose.override.20-reverse-proxy.yml -f docker-compose.override.30-options.yml build web
